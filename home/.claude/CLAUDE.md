...
- use a multi-line subject/body message with a dash list in the body, a subject line of 50 characters or less, body lines of 72 characters or less, and real newlines instead of `\n`.
...
- Prefer boring, readable code to over-engineered code.
